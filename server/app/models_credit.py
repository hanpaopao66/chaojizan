...
比如配送异常裁决、售后判责的 72 小时申诉期过了,或者违规记录本来就没有结构化的申诉入口
(骑手的售后判责 2026-09-14 起也有了原通道 after_sale_rider,和商家的售后判责对齐)。一条记录一次(和 appeals 表同一条规矩),工单是申诉的人和客服说话的地方,
...
(按送达处理算顾客的、裁成退款按种类算骑手或商家的),一条售后同一时刻只有一个判责方。
"""
