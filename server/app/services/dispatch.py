...
def public_spec() -> dict:
    ...
    **从上面的常量读,不另写字面量。** 抄一份的话迟早和真实算法对不上,
    ...
    return {
        ...
        "same_way_definition": {
            "formula": "绕路增量 =(当前位置 → 新单取餐 → 新单送达 → 手头单下一站)"
                       "−(当前位置 → 手头单下一站);"
                       "手头单没取餐时下一站是那家店,取了餐才是送达点",
...
CHANGELOG = [
    {
        "date": "2026-09-14",
        "what": "等餐超时补偿停发:不再把骑手到店干等的时间折成钱给骑手;"
                "等餐时长照旧记录、照旧公示,也不向商家收钱。之前已经结给骑手的补偿不动。",
        "why": "等餐补偿由平台出钱,而平台没有这笔钱 —— 不做平台出钱的赔付。"
               "等餐是商家那一环的问题,但向商家收钱会让商家宁可晚点按「出餐」,"
               "数据一失真 ETA 和派单全跟着歪,所以照「出餐时长君子协定」只记录、只公示。"
               "等餐时长仍是骑手申诉超时的证据,系统自动附上。",
    },
    {
        "date": "2026-09-10",
        "what": "顺路判定的参照点:手头单还没取餐时改用那家店的位置,"
                "取了餐才用送达点。",
        "why": "原来一律按送达点算绕路增量,可没取餐的单骑手要先去店里,"
               "基准点根本不是他要去的地方,顺路等级会偏。"
               "只影响排序,不影响钱。",
    },
    {
        "date": "2026-08-29",
