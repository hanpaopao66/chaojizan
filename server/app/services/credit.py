...
- **商家**:平台判出来的售后商家责任 —— after_sales.fault = merchant,**并且**是下面三条之一:
  ...
  2026-09-15 起退全款、骑手那份商家另出,见 services/merchant_fault;
        ...
        items = [{
            **common,
            ...
            "counts": f"平台判为商家责任的,每次 −{FAULT_POINTS}:① 你拒绝的售后,顾客申诉、"
                      ...
                      "责任、由你承担退款;③ 顾客的食品安全投诉经平台核实成立、由你承担退款"
                      "(同一单另记了「食品安全事故」违规的,只按违规扣,不重复扣)。"
                      "你自己同意的售后和退款不算。钱另外算:顾客拿回全款(含配送费和小费),"
                      "这单净额冲回,骑手那份配送费和小费照归骑手、由你另出",
...
_NOT_COUNTED = {
    ...
    "rider": [
        ...
        {"what": "到店未出餐、餐品不齐", "why": "那是商家那一环的问题:平台裁决退款时判的是商家责任、"
         "由商家承担退款,不算你的,你这一趟的配送费和小费照常结算(由商家出)"},
