...
**营销补贴** —— 拿钱买增长。平台真正认的是**平台自己判错了**的那几笔:申诉改判成立,
钱由平台补回(routers/appeals)。原来还有两笔「履约成本」—— 等餐超时平台补骑手(2026-09-14 停发)、
无人接单取消时平台赔商家餐损(2026-09-15 停赔)—— 平台没有钱,都停了:等餐时长照实记录,
无人接单改成事前提醒商家「骑手接单后再出餐,或改为自己配送」。

## 唯一的例外:向责任方收钱会制造更坏的激励时,改用数据治理

骑手到店等餐,责任在商家(出餐慢),但不向商家收钱:**转嫁商家会让商家宁可晚点按
「出餐」**,数据一失真,出餐时长统计、ETA、派单全跟着歪。所以「治理靠数据,不靠罚钱」
—— 等餐时长照实记录、公示(出餐时长君子协定)。原来这段时间由平台补给骑手(#145),
2026-09-14 拍板「平台没有钱,不做平台出钱的赔付」之后停发,只记录不折成钱。
...
#:   无人接单兜底  商家拿全额、用户也全额退 —— 差额是**平台认赔**(历史;2026-09-15 起不再赔)
...
def public_spec() -> dict:
    ...
    return {
        ...
        "what_platform_bears": {
            "rule": "平台没有钱,不出钱赔付;平台判错了,平台自己认 —— 申诉改判成立的钱由平台补回",
            "examples": [
                "平台判错了:骑手、商家、顾客对判责申诉,改判成立,扣的、冲的、该退的钱都由平台补回,"
                "每一笔进透明中心「申诉改判」和公开账本",
                # 2026-09-15 起:运力不足没人接单,顾客全额退、佣金不收,已出餐的餐损平台**不再赔**
                "运力不足没人接单:顾客全额退,佣金不收;已出餐的餐损平台不赔 —— "
                "所以还没骑手接单时,商家端会提醒「建议骑手接单后再出餐,或改为自己配送」",
                # 「骑手到店等餐:补偿由平台出」2026-09-14 起不再成立(等餐补偿停发,ec85765)
            ],
            "why_not_subsidy": "补贴是拿钱买增长;改判补回是平台为自己判错认账。"
                               "两者都花钱,但性质不同。",
        },
        "the_one_exception": {
            "case": "骑手等餐,责任在商家,却不向商家收钱",
            "why": "转嫁商家会让商家宁可晚点按「出餐」。数据一失真,"
                   "出餐时长统计、预计送达、派单全跟着歪。治理靠数据,不靠罚钱 —— "
                   "等餐时长照实记录、公示。原来这段时间由平台补给骑手,"
                   "2026-09-14 起平台不出这笔钱,补偿停发。",
        ...
        "appeal": {
            ...
            "window_hours": 72,
            "what_happens": "平台复核。改判成立撤销那一条判责,顾客拿到的退款不追回。"
                            "平台判错了,平台自己认:骑手责任改判,判责时扣的钱退回;商家售后判责"
                            "改判,冲掉的净额和另出的配送费、小费补回;顾客的取消分摊、按送达处理"
                            "改判,钱原路退回 —— 这些钱都由平台出,进透明中心「申诉改判」和公开账本。",
        },
    }
