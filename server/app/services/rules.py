...
def _appeal_section(hours: int) -> dict:
    ...
    return {
        ...
        "items": [
            ...
            # 2026-09-14 拍板「平台没有钱」之后,改判时的钱各支不一样,照实写(见 routers/appeals)
            "改判时的钱:骑手责任改判,判责时扣的钱退回;商家售后判责改判,被冲掉的净额和另出的"
            "配送费、小费都不补回(平台不出这笔钱);顾客的取消分摊、「按送达处理」改判,"
            "钱由平台原路退回",
        ],
    }
        ...
        sections = [
            ...
            },
            {
                ...
                "items": [
                    ...
                    f"平台判的,{appeal_hours} 小时内可以申诉(改判时钱怎么走见「申诉」一节)",
                ],
            },
            {
                "title": "排序怎么来的",
