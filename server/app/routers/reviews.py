...
# 回复模板:差评回复最难的不是打字,是"第一句该说什么"。
# 这几条是行业里被验证过的结构:先道歉 → 认具体的问题 → 给方案。
# **故意不做"一键自动回复"** —— 千篇一律的模板回复顾客一眼看得出,
# 比不回更伤;这里只给起手式,商家自己改成自家的话
REPLY_TEMPLATES = {
    "bad": [
        {"label": "口味不满意",
         "text": "非常抱歉这次没做好。我们已经把您反馈的问题告诉后厨,"
                 "会重新调整口味。方便的话告诉我们具体哪里不对,下次给您做好。"},
        {"label": "出餐慢/送得晚",
         "text": "抱歉让您久等了。当时确实赶上高峰,是我们没安排好。"
                 "已经在调整备餐节奏,下次一定更快。"},
        {"label": "少送/漏送",
         "text": "实在抱歉,漏了您的东西。已经在核对打包流程避免再发生,"
                 "缺的部分您可以申请售后,我们全额补上。"},
        {"label": "包装洒漏",
         "text": "抱歉,包装没封好让您受影响了。我们已换成更紧的封口方式,"
                 "并会给骑手加固提醒。"},
    ],
    "good": [
        {"label": "感谢惠顾",
         "text": "谢谢您的认可!我们会保持这个水准,欢迎再来。"},
        {"label": "回头客",
         "text": "谢谢一直支持!老顾客的每次光临我们都记着,下次给您留最新鲜的。"},
    ],
}


@router.get("/merchants/me/reply-templates")
async def reply_templates(
    user: User = Depends(require_role("merchant")),
):
    """回复话术模板(平台预置,商家改完再发)。

    结构是"先道歉 → 认具体问题 → 给方案",这是行业里被验证过的顺序。
    **不做一键自动回复**:模板腔顾客一眼看得出,比不回更伤 ——
    这里只省掉从零打字的那一步。
    """
    return {
        "templates": REPLY_TEMPLATES,
        "note": "建议改成自家的话再发。原样发模板顾客看得出来,"
                "差评回复的价值在于让人觉得被认真对待。",
    }
