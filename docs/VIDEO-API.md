...
- 投稿(建稿、挂分 P、提交)**不要求实名**,只要手机号账号(2026-09-15 运营方定;原 D11 要求实名,服务端和客户端的门槛都去掉了)。
...
| 403 | 没权限:别人的稿件、UP 主关了弹幕 / 评论、有拉黑关系、原审核员处理自己结论的申诉、被禁言 / 封号 |
...
| mentions | 文中 @ 到的人(超级赞号小写);没注册的号不在这里,原样当文字显示。对方关了「按超级赞号找到我」的也不在这里,和没注册的号一样:发的时候不解析、不通知,展示时按他**现在**的开关再滤一遍(关掉之前发的评论也不再给链接,重新打开恢复) |
...
- 通知:评论视频 → UP 主「回复我的」;回复 → 被回复的人「回复我的」;@ → 被 @ 的人「@我的」
  (关了「按超级赞号找到我」的人不通知,和 @ 一个没注册的号一样;拉黑的照旧不通知);
