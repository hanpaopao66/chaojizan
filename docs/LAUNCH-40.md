...
- 表里是**没写过**开关时的缺省值。生产上 `video_enabled`、`video_upload_enabled`、`bots_enabled` 已在 2026-09-15 由后台打开
  (运营方知情后先开放,见 [COMPLIANCE-40.md](COMPLIANCE-40.md) 第 5、11 条),要关就在开关页拨回去;
...
- [ ] 后台开关页确认:`calls_enabled` 显示「关」;`video_enabled`、`video_upload_enabled`、`bots_enabled` 2026-09-15 起在生产上是「开」
  (运营方知情后先开放,见 [COMPLIANCE-40.md](COMPLIANCE-40.md) 第 5、11 条),视频审核在后台「社区 → 视频审核」
