// 官方小程序共用一份构建配置:vite build --mode <名字>(notepad / 2048 / snake / blocks / minesweeper)
...
/** 小程序 → 开发服务器端口 */
const APPS: Record<string, number> = { notepad: 5190, '2048': 5191, snake: 5192, blocks: 5193, minesweeper: 5194 }
