...
/// ## 和对账 tab 的「经营分析」怎么分
///
/// 两个分析页分在两个 tab,商家找「我的数据」时容易猜错(#33 第 5 节遗留)。
/// 分工是:**这一页答「在变好还是变坏」**(近 8 周趋势、时段热力、
/// 出餐时长分布、流失去向,打烊后复盘用);**经营分析答「最近怎么样」**
/// (近 7/30 天的总览、菜品 TOP10、复购、经营质量,随手查)。
///
/// 没有合并,因为场景真的不同。但两边都要能点到对方 ——
/// 经营分析页底部有回这里的入口,这里的入口副标题写明分工。
